  ...
  return (
    ...
    >
      <path
        ...
        className={clsx(
          'dark:group-hover:fill-[##78c6a3] transition-all dark:fill-[#353346] fill-[#C0BFC4] group-hover:fill-[#78c6a3]',
      ...
      <path
        ...
        className={clsx(
          'dark:group-hover:fill-[#354f52] transition-all dark:fill-[#C0BFC4] fill-[#5B5966] group-hover:fill-[#52796f] ',
